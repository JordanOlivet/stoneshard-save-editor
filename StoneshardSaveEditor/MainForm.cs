...
namespace StoneshardSaveEditor
{
    public partial class MainForm : Form
    {
        ...
        {
            InitializeComponent();
            saveFolderTextBox.Text = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "StoneShard");
        }
        ...
        private void treeView1_NodeMouseClick(object sender, TreeNodeMouseClickEventArgs e)
        {
            ...
            InventoryDataBindingSource.DataSource = _saveEditor.Inventory;
        ...
        {
            _saveEditor.Save();
            MessageBox.Show("Save file updated" + Environment.NewLine + Environment.NewLine + "Backup file: " + _saveEditor.BackupFilePath, "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
            saveButton.Enabled = false;
        }

        private void numUpDownMoney_ValueChanged(object sender, EventArgs e)
        {
            EnableSaveButton(sender, e);
        }

        private void numUpDownMoney_KeyPress(object sender, KeyPressEventArgs e)
        {
            EnableSaveButton(sender, e);
        }
    }
